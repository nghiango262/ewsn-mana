...
export class Client {
	...
	public connect(options: ConnectionOptions, callback: (error?: Error) => void) {
		...
		if (opts.tls && opts.tls.p12) {
			...
			opts.tls.p12 = opts.tls.p12 === undefined? null : opts.tls.p12.toString('base64') as any;
		}

		if (opts.tls && opts.tls.caDer) {
			opts.tls = Object.assign({}, opts.tls);
			opts.tls.caDer = opts.tls.caDer === undefined? null : opts.tls.caDer.toString('base64') as any;
		}
